...
def compile_aggregated_sims_data(filepath, combinations, ie, name_add, scenario_name, quantile):
...
#%% compile data
# compile data for current conditions
...
df_combined_hist = compile_aggregated_sims_data(filepath, combinations, ie, name_add='Baseline_IE_NoInf_', scenario_name='Baseline', quantile=0.8)
df_combined_hist.to_csv(filepath + 'df_combined_hist_Fig7.csv')
df_combined_hist = pd.read_csv(filepath + 'df_combined_hist_Fig7.csv')

# modcool
df_combined = compile_aggregated_sims_data(filepath, combinations, ie, name_add='Baseline_IE_', scenario_name='Moderate', quantile=0.8)
df_combined.to_csv(filepath + 'df_combined_modcool_Fig7.csv')
df_combined = pd.read_csv(filepath + 'df_combined_modcool_Fig7.csv')
...
df_combined_cc = compile_aggregated_sims_data(filepath, combinations, ie, name_add='Baseline_IE_', scenario_name='Dry', quantile=0.8)
df_combined_cc.to_csv(filepath + 'df_combined_cc_Fig7.csv')
df_combined_cc = pd.read_csv(filepath + 'df_combined_cc_Fig7.csv')
...
# plt.scatter(df_combined['annual_avg_cost'], df_combined['AR_80perc'], alpha=0.7, s=12, c='dodgerblue', marker=)
...
# plt.title('Tradeoffs between affordability and assistance costs', fontsize=11, fontweight='bold')
plt.savefig('../../outputs/Figures/Figure7_IE_Scatter_AR_vs_AssistCost.jpg',
